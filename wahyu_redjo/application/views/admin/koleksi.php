                ...
                if ($paket) :
                    foreach ($paket as $pkt) : ?>
                        <tr>
                            ...
                            <td><?php echo $pkt->jenis_paket ?></td>
                            <td><?php
                            echo 'Rp. '.number_format($pkt->harga_paket, 0, ".", ",");  ?></td>


                            <td>
                                <a href="<?= base_url('admin/edit_paket//').$pkt->id_paket ?>"
                                    class="btn btn-warning btn-circle btn-sm"><i class="fa fa-edit"></i></a>

                                <a onclick="return confirm('Yakin ingin hapus?')"
                                    href="<?= base_url('admin/hapus_paket//').$pkt->id_paket ?>"
