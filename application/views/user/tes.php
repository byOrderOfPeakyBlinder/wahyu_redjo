<section class="about_section layout_padding2-top layout_padding-bottom">
    <div class="col-md-16 col-md-offset-2 col-xs-12">
                            ...
                            <div class="col-md-2 col-xs-12">
                                <div class="share">
                                    ...
                                    <ul>
                                        <li>
                                            <a target="_blank"
                                                href="https://instagram.com/home?status=http%3A//www.wowthemes.net">
        ...
        <span style=" color:black"><?=$isi_blog['judul']?></span>
                ...
                <div class="container">
                    <b>
                        <h3 style="font-family:arial;" class="posttitle">Author</h3>
                    </b>
                    <br>
                    <span>
                        <h3>
                            <color:black; a href="<?= base_url('user'); ?>"> <img
                                    src="<?= base_url('assets/images/avatar.png')?>">
                                Wahyu Redjo</color:black;>
                        </h3>
                    </span>
                </div>
            </div>
