            ...
            <div class="card mb-3" style="width: 180rem;">
                <div class="col-md-8">
                    <div class="card" style="width: 75rem;">
                        <img class="card-img-top" src="<?= base_url('assets/images/blog/').$isi_blog['foto']?>">
                        <p class="card-text" <h1><?= $isi_blog['judul']?></h1>
                            <center>
                                <p><?= $isi_blog['isi']?></p>
                            </center>
                        </p>
        ...
        <div class="row">
            ...
            <div class="col-md-8 col-md-offset-2 col-xs-12">
                <div class="mainheading">
                    ...
                    <h1 class="posttitle"> <a class="card-text"><?= $isi_blog['judul']?></h1>
                ...
                <section class="about_section layout_padding2-top layout_padding-bottom">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="card mb-3" style="width: 130rem;">
                                <div class="col-md-8">
                                    <div class="card" style="width: 50rem;">
                                        <img class="card-img-top"
                                            src="<?= base_url('assets/images/blog/').$isi_blog['foto']?>">
                                        <p class="card-text" <h1><?= $isi_blog['judul']?></h1>
                                            <center>
                                                <p><?= $isi_blog['isi']?></p>
                                            </center>
            ...
            <div class="row listrecent listrelated">
                ...
                <div class="col-md-4">
                    ...
                    <div class="card-block">
                        <h2 class="card-title"><a href="post.html">Best recreational places to visit on a
                                holiday</a></h2>
                ...
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <div class="card-block">
                            <h2 class="card-title"><a href="post.html">Little red dress and a perfect summer</a>
                            </h2>
                            <div class="metafooter">
                                <div class="wrapfooter">
                                    <span class="meta-footer-thumb">
