...
<div class="container">
    ...
    <p style="color:grey;">
        Dapatkan berita,informasi dan promo terbaru dan terbaik dari kami.
    </p>

    <section class="about_section layout_padding2-top layout_padding-bottom">
        <!-- <div class="design-box mb-3">
                    ...
                    <div class="row no-gutters">
                        ...
                        <div class="col-sm-8">
                            <div class="card-body">
                                ...
                                <a href="<?= base_url('user/isi_blog//').$blg->id_blog; ?>" style="color:Coral">Read
                                    More
                                    +</a>
                            </div>
                        </div>
